...
struct RestoreService {
    ...
    func restore(_ backup: BackupFile) throws -> Result {
        ...
        // сообщило об ошибке. Блок обязан оставаться синхронным: у общего
        // контекста включено автосохранение, и любое ожидание внутри дало бы
        // ему шанс записать половину работы.
        do {
            try wipe()
